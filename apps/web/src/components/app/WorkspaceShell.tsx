...
import { AppWorkspaceStepper } from "@/components/app/AppWorkspaceStepper";
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="relative">
        <div
          ...
          aria-hidden
        >
          <div className="absolute left-[10%] top-0 h-[320px] w-[480px] rounded-full bg-emerald/[0.08] blur-[100px]" />
