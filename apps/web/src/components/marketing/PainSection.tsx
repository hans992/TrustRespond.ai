...
export function PainSection() {
  return (
    <section id="problem" className="relative overflow-hidden bg-surface-card/30 px-6 py-28 md:py-32">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-slate-300">2 weeks average completion time per questionnaire</p>
              </div>
              <div className="flex items-start gap-3">
                <TrendingDown className="mt-0.5 h-5 w-5 shrink-0 text-orange-400" />
                <p className="text-slate-300">1-3 engineering days lost per review cycle</p>
              </div>
              <div className="flex items-start gap-3">
                <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-yellow-400" />
                <p className="text-slate-300">Deals delayed or lost due to slow security responses</p>
              </div>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.15} direction="up">
          <motion.div
            ...
            className="glass-card rounded-3xl border border-white/10 p-8 transition-shadow duration-300 hover:border-emerald/20 hover:shadow-card-hover"
          >
            <h3 className="text-lg font-semibold text-neutral-50">Cost of Doing Nothing</h3>
            <p className="mt-1 text-sm text-slate-500">Per enterprise deal, per quarter</p>

            <div className="mt-6">
              <div className="flex justify-between border-b border-white/10 py-3 text-sm">
                <span className="text-slate-400">CTO time (40 hrs x $200/hr)</span>
                <span className="text-neutral-200">$8,000</span>
              </div>
              <div className="flex justify-between border-b border-white/10 py-3 text-sm">
                <span className="text-slate-400">Delayed deal close (avg 14 days)</span>
                <span className="text-neutral-200">$47,000 at risk</span>
              </div>
              <div className="flex justify-between border-b border-white/10 py-3 text-sm">
                <span className="text-slate-400">Opportunity cost (features not shipped)</span>
                <span className="text-neutral-200">Immeasurable</span>
              </div>
              <div className="flex justify-between border-b border-white/10 py-3 text-sm">
                <span className="text-slate-400">Deals lost to faster competitors</span>
                <span className="text-neutral-200">1-2 per quarter</span>
              </div>

              <div className="mt-2 flex justify-between pt-2">
                <span className="text-slate-300">Total quarterly exposure</span>
